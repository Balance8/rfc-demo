    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Welcome to the RFC Demo!</CardTitle>
          <CardDescription>
            Click Login, You don't need a username or password
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form>
                ...
                <div className="grid gap-2">
                  <div className="flex items-center">
                    ...
                    <Button asChild variant="link" className="ml-auto p-0">
                      <Link href="/dashboard">Forgot your password?</Link>
                    </Button>
                  </div>
